...
*/
function displayAreaOptions(element) {
    ...
    let buttonGroup = $('<div class="btn-group btn-group-sm" role="group" aria-label="edit buttons">' +
        '<button class="btn btn-link" data-test-id="remove-tag-button" type="button" onclick="removeAreaTag(this)">remove</button>' +
...
function editAreaTag(button) {
    ...
    ele.append('<input type="button" data-test-id="save-tag-button" value="Save" onclick="saveAreaTag(this)"/>');
    ele.append('<input type="button" data-test-id="cancel-tag-button" value="Cancel" onclick="cancelAreaTag(this)"/>');
...
* cancels a tag
*/
function cancelAreaTag(element) {
    let ele = $(element);
