...
function editEnvTag(button, id) {
    ...
    ele.append('<input type="button" data-test-id="save-tag-button" value="Save" onclick="saveEnvTag(this,' + id + ')"/>');
    ele.append('<input type="button" data-test-id="cancel-tag-button" value="Cancel" onclick="cancelEnvTag(this,' + id + ')"/>');
