...
class BootStrap {
    ...
    void seedTestData() {
        ...
        def at = new AutomatedTest(project: project, fullName: "com.manager.quality.everest.myfirsttest", name: "My First Test").save(failOnError: true)
        def r4 = new TestResult(result: "FAILED", automatedTest: at)
        def r5 = new TestResult(result: "FAILED", automatedTest: at)
        def a = new AutomatedTest(project: project, fullName: "com.manager.quality.everest.mysecondtest", name: "My Second Test").save(failOnError: true)
