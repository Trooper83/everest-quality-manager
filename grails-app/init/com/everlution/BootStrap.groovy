...
class BootStrap {
    ...
    void seedTestData() {
        ...
        new Project(name: "bootstrap project234234", code: "qqq").save()
        new Project(name: "bootstrap project546435", code: "www").save()
        new Project(name: "bootstrap projectrterwter", code: "eee").save()
        new Project(name: "bootstrap projectfdgdfg", code: "rrr").save()
        new Project(name: "bootstrap projectdfg", code: "ttt", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectvbcb", code: "tty", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectvcbcvb", code: "yyy", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectertet", code: "uuu", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectr345345", code: "iii", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projecthjghhgj", code: "ooo", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectvbcbv", code: "ppp", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projecteee", code: "aaa", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectttt", code: "sss", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectyyy", code: "ddd", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectuuu", code: "fff", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectiii", code: "ggg", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectqqq", code: "hhh", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectwww", code: "jjj", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projecthhh", code: "kkk", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectjjj", code: "lll", areas: [area], environments: [env]).save()
        new Project(name: "bootstrap projectfff", code: "zzz", areas: [area], environments: [env]).save()
    }
}
