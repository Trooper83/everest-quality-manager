...
class StepTemplateController {
     ...
     */
    @Secured("ROLE_BASIC")
    def save(StepTemplate template, com.manager.quality.everest.controllers.command.LinksCmd links) {
        withForm {
            if (template == null) {
                notFound()
                return
     ...
     */
    @Secured("ROLE_BASIC")
    def update(StepTemplate template, Long projectId, com.manager.quality.everest.controllers.command.LinksCmd links, com.manager.quality.everest.controllers.command.RemovedItems removedItems) {
        withForm {
