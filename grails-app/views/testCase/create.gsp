                    ...
                    <div class="container">
                        <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="builder-tab" data-bs-toggle="tab" data-bs-target="#builder-tab-pane" type="button" role="tab" aria-controls="builder-tab-pane" aria-selected="true">Builder</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="free-form-tab" data-bs-toggle="tab" data-bs-target="#free-form-tab-pane" type="button" role="tab" aria-controls="free-form-tab-pane" aria-selected="false">Free Form</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active mb-3" id="builder-tab-pane" role="tabpanel" aria-labelledby="builder-tab" tabindex="0">
                                <div class="card-body">
                                    <div class="row border-bottom">
                                        <p class="col-8">Steps</p>
                                        <p class="col-4">Suggested Steps</p>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-6">
