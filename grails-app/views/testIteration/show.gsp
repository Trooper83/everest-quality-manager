...
<html>
    ...
    <body>
        ...
        <div id="show-testIteration" class="content scaffold-show" role="main">
            ...
            <f:display bean="testIteration" />
            <g:form resource="${this.testIteration}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.testIteration}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
