...
<div class="container">
    <div class="row">
        ...
        <main class="col-md-9 col-lg-10 ms-sm-auto mt-3">
            ...
            <g:form resource="${this.stepTemplate}" method="PUT"
                    uri="/project/${stepTemplate.project.id}/stepTemplate/update/${stepTemplate.id}" useToken="true">
                <g:hiddenField name="version" value="${this.stepTemplate?.version}" />
                <div class="card mt-3 mb-5">
                    ...
                    <div class="card-body">
                        <g:hiddenField name="project" value="${stepTemplate.project.id}"/>
                        <div class="col-8 required mb-3">
                            <label class="form-label" for="name">Name</label>
                            <g:textField class="form-control" name="name" value="${stepTemplate.name}" maxLength="100"></g:textField>
                        </div>
                        <div class="col-8 mb-3">
                            <label class="form-label" for="act">Action</label>
                            <g:textArea class="form-control" name="act" value="${stepTemplate.act}" maxLength="500"></g:textArea>
                        </div>
                        <div class="col-8 mb-3">
                            <label class="form-label" for="result">Result</label>
                            <g:textArea class="form-control" name="result" value="${stepTemplate.result}" maxLength="500"></g:textArea>
                        </div>
                    </div>
                </div>
