        ...
        <main class="col-md-9 col-lg-10 ms-sm-auto mt-3">
            ...
            <g:form class="mt-3" uri="/project/${project.id}/scenarios" params="['isSearch': 'true']" useToken="true">
                <div class="col-lg-6 hstack gap-3">
                    <g:textField class="form-control" name="searchTerm" autocomplete="off" placeholder="Scenario Name"
                                 value="${params.searchTerm}"/>
                    <button class="btn btn-primary" type="submit" id="searchButton">Search</button>
                    <g:link uri="/project/${project.id}/scenarios" elementId="resetLink">Reset</g:link>
                </div>
            </g:form>
            <div class="row mt-3">
                <div class="col">
